...
<p>
    ...
    The results are already pretty remarkable as I could observe a boot time of 602 milliseconds.
</p>
<p>(Edit Sept 17, 2017, prior to this date all my time conversions from seconds to milliseconds have been wrong. Thank you Faris for pointing it out :) )</p>
<h3>
...
<p>(Edit Sept 17, 2017, prior to this date all my time conversions from seconds to milliseconds have been wrong.)</p>
...
<p>
    ...
    This is a big leap for developer productivity. As we can see here it took only 386 milliseconds to reload.
</p>
<p>(Edit Sept 17, 2017, prior to this date all my time conversions from seconds to milliseconds have been wrong.)</p>
{% highlight shell %}
...
<p>We can see that the boot time is of 7 milliseconds!</p>
<p>(Edit Sept 17, 2017, prior to this date all my time conversions from seconds to milliseconds have been wrong.)</p>
